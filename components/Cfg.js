...
const _cfgPath = `${_path}/plugins/tea-plugin/components/`
let cfg = {}

let configPath = `${_path}/plugins/tea-plugin/config/`
let defSetPath = './plugins/tea-plugin/defSet/'
