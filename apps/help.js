...
const helpPath = `${_path}/plugins/tea-plugin/resources/help`
...
export class help extends plugin {
	constructor() {
		super({
			...
			rule: [
				{
					reg: "^#?(茶|扩展|扩充|拓充|扩大)?(命令|帮助|菜单|help|说明|功能|指令|使用说明)$",
					fnc: 'help'
				},
        {
          reg: "^#?茶版本$",
...
async help (e) {
  if ((!/茶/.test(e.msg)) && (!/扩展/.test(e.msg)) && (!/扩充/.test(e.msg)) && (!/拓充/.test(e.msg)) && (!/扩大/.test(e.msg)) && !Cfg.get('sys.help', false)){
    return false
  }
